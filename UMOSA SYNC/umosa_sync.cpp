...
void CALLBACK create_sine(UINT uTimerID, UINT uMsg, DWORD_PTR dwUser, DWORD_PTR dw1, DWORD_PTR dw2)
{
...
int main()
{
    ...
    QueryPerformanceCounter(&startingTime);
    timeSetEvent(INTERVAL, 0, (LPTIMECALLBACK)&create_sine, 0, TIME_PERIODIC);
